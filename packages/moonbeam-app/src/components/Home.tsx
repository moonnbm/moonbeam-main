...
import {Divider, IconButton, List, MD3Colors, SegmentedButtons} from 'react-native-paper';
    ...
    return (
        <SafeAreaView style={commonStyles.rowContainer}>
            <ImageBackground
                ...
                source={require('../../assets/dashboard-top-view-background.png')}>
                <KeyboardAwareScrollView
                    ...
                    <View style={styles.topBarView}>
                        <View style={styles.dashboardColumnItemFirst}>
                            ...
                            >
                                <Avatar.Accessory onPress={() => console.log("PRESSSEd")} size={15}/>
                            </Avatar>
                        </View>
                        ...
                        <ScrollView>
                            {segmentedValue === 'transactions' ?
                                <List.Section>
                                    ...
                                    <Divider style={styles.dashboardListDivider}/>
                                    <List.Item
